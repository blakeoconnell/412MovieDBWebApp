...
Connection conn = DriverManager.getConnection(jdbcURL, user, password);
	...
	try {
        ...
        ResultSet rs = stmt.executeQuery("select g.name Genre, avg(r.rating) Rating from genres g, hasagenre h, ratings r where g.genreid = h.genreid and r.movieid = h.movieid and h.movieid in (select movieid from search_helper) group by g.name");
