...
Connection conn = DriverManager.getConnection(jdbcURL, user, password);
	...
	try {
        ...
        ResultSet rs = stmt.executeQuery("select g.name Genre, avg(r.rating)*10 Rating from genres g, hasagenre h, ratings r where g.genreid = h.genreid and r.movieid = h.movieid group by g.name");
